<?php
	...
	$dlv = new Delivery($db);
	$dlv_teacher = new Delivery_Teacher($db);
	...
	$dlv_teacher->id_tch = $id_teacher;
	$dlv_teacher->sbj = $dlv->sbj;
	$dlv_teacher->id_dlv = $id_delivery;
	$teacher_array['average'] = $dlv_teacher->average_notes_without_percent();
